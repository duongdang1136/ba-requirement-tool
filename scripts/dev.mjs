...
const result = spawnSync(
  ...
  ],
  {
    ...
    env: {
      ...
      ASR_PROVIDER: process.env.ASR_PROVIDER ?? 'cpu',
      ...
      UPLOAD_CHUNK_SIZE_MB: process.env.UPLOAD_CHUNK_SIZE_MB ?? '8',
      DIARIZATION_SPEAKER_MATCH_THRESHOLD: process.env.DIARIZATION_SPEAKER_MATCH_THRESHOLD ?? '0.62',
      LLM_PROVIDER: process.env.LLM_PROVIDER ?? 'ollama',
      OLLAMA_BASE_URL: process.env.OLLAMA_BASE_URL ?? 'http://localhost:11434',
      OLLAMA_MODEL: process.env.OLLAMA_MODEL ?? 'qwen2.5:7b',
      OLLAMA_FALLBACK_MODEL: process.env.OLLAMA_FALLBACK_MODEL ?? 'qwen2.5:3b',
      OLLAMA_TIMEOUT_SECONDS: process.env.OLLAMA_TIMEOUT_SECONDS ?? '300',
      OLLAMA_CONTEXT_TOKENS: process.env.OLLAMA_CONTEXT_TOKENS ?? '8192',
